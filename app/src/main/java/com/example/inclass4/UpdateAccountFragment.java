...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        updateAcctName = v.findViewById(R.id.emailInput);
        updateAcctName.getText().toString();

        updateAcctPassword = v.findViewById(R.id.passwordInput);
        updateAcctPassword.getText().toString();
        ...
        updateAcctSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!updateAcctName.getText().toString().matches("") && !updateAcctPassword.getText().toString().matches("")) {
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.containerView, new AccountFragment(), null).addToBackStack(null).commit();
                } else{
                    Toast.makeText(getContext(), "Please user name and password", Toast.LENGTH_SHORT).show();
                }}
        });
